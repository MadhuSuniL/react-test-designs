...
<h1 className='text-md p-2 font-bold text-center'>Compare, book, and manage your freight across the world’s top logistics providers, all on one platform.</h1>
...
<path d="M14 18.3333V2.33333M25.2266 5.49333C26.3866 5.96 27.1066 7.33333 26.84 8.54666L26.2933 11.0267C25.3466 15.2933 22 18.3333 17.1733 18.3333H10.8266C5.99998 18.3333 2.65331 15.2933 1.70664 11.0267L1.15998 8.54666C0.893311 7.33333 1.61331 5.96 2.77331 5.49333L4.66664 4.73333L12.0133 1.78666C13.2933 1.28 14.7066 1.28 15.9866 1.78666L23.3333 4.73333L25.2266 5.49333Z" stroke="#0075FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
 ...
 Freight Services</h1>
    ...
    <h1 className='m-4 text-sm font-bold flex justify-center items-center'><svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8.33333 6V5.06666C8.33333 3.00166 8.33333 1.33333 12.0667 1.33333H13.9333C17.6667 1.33333 17.6667 3.00166 17.6667 5.06666V6M8.33333 24.6667H17.6667C22.3567 24.6667 23.1967 22.7883 23.4417 20.5017L24.3167 11.1683C24.6317 8.32166 23.815 6 18.8333 6H7.16667C2.185 6 1.36833 8.32166 1.68333 11.1683L2.55833 20.5017C2.80333 22.7883 3.64333 24.6667 8.33333 24.6667Z" stroke="#FF4747" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

Business Services</h1>
    <hr/>
    <p className='text-[12px] p-4 px-5'>
    We support your goals for growth with cargo insurance, online payments and paperless workflow. Take your business to the next level.</p>
    </div>

    <div className='hover:shadow-xl hover:scale-95 hover:shadow-gray-800 duration-150 ease-linear p-2 m-2 rounded-lg shadow-lg shadow-gray-500 '>
    <h1 className='m-4 text-sm font-bold flex justify-center items-center'> <svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M2.00001 1H3.00001C1.05004 6.84157 1.05004 13.1584 3.00001 19H2.00001M9.00001 1C9.97001 3.92 10.46 6.96 10.46 10" stroke="#FF6813" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

Shipping & Logistics</h1>
    <hr/>
    <p className='text-[12px] p-4 px-5'>
    Find powerful solutions to meet your diverse transportation needs. Agile solutions to handle all your supply chain needs.</p>
    </div>
    ...
    <h1 className='m-4 text-sm font-bold flex justify-center items-center'> <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M16 17.86H15.24C14.44 17.86 13.68 18.17 13.12 18.73L11.41 20.42C10.63 21.19 9.36 21.19 8.58 20.42L6.87 18.73C6.31 18.17 5.54 17.86 4.75 17.86H4C2.34 17.86 1 16.53 1 14.89V3.97999C1 2.33999 2.34 1.00999 4 1.00999H16C17.66 1.00999 19 2.33999 19 3.97999V14.89C19 16.52 17.66 17.86 16 17.86Z" stroke="#47A7FF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<svg width="13" height="15" viewBox="-2 -3 12 9" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1 3.15999C1 2.22999 1.76 1.46999 2.69 1.46999C3.62 1.46999 4.38 2.22999 4.38 3.15999C4.38 5.03999 1.71 5.23999 1.12 7.02999C1 7.39999 1.31 7.76999 1.7 7.76999H4.38M10.04 7.75999V2.04999C10.0405 1.92364 9.99982 1.80057 9.92401 1.69949C9.84819 1.59841 9.74145 1.52485 9.62 1.48999C9.49772 1.45546 9.36758 1.46111 9.24876 1.50612C9.12994 1.55113 9.02871 1.63311 8.96 1.73999C8.24 2.89999 7.46 4.21999 6.78 5.37999C6.67 5.56999 6.67 5.81999 6.78 6.00999C6.89 6.19999 7.1 6.31999 7.33 6.31999H11" stroke="#47A7FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
...
24/7 Support</h1>
    <hr/>
    <p className='text-[12px] p-4 px-5'>
    Receive support from our experts all over the world at every stage of the process, 24/7.</p>
    </div>
    </div>
